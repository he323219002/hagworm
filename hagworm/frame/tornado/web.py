...
from hagworm.extend.metaclass import SubclassMetaclass
from hagworm.extend.asyncio.base import Utils
from hagworm.extend.asyncio.net import DownloadBuffer


def http_basic_auth(realm, username, password):

    def __http_basic_auth(func):
        ...
        def __wrapper(request, *args, **kwargs):
            ...
            try:
                ...
                if(auth_header):
                    ...
                    if(auth_info == r'{0}:{1}'.format(username, password)):
