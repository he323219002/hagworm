...
_ENUM_STATE = Const()
_ENUM_STATE.PENDING = 0
_ENUM_STATE.FETCHING = 1
_ENUM_STATE.FINISHED = 2
...
class Downloader(_HTTPClient):
    ...
    def __init__(self, file, retry_count=5, read_timeout=65536, conn_timeout=60, **kwargs):
        ...
        self._state = _ENUM_STATE.PENDING
    ...
    def finished(self):
        ...
        return self._state == _ENUM_STATE.FINISHED
    ...
    async def _handle_response(self, response):
        ...
        if(self._state != _ENUM_STATE.PENDING):
            return False

        result = False

        self._state = _ENUM_STATE.FETCHING
        ...
        self._state = _ENUM_STATE.FINISHED
