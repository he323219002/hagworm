...
class Result(dict):
    ...
    def __init__(self, errcode=0, errmsg=r'', data=None, extra=None):

        super().__init__(errcode=errcode, errmsg=errmsg)
    ...
    def errcode(self):
        ...
        return self.__getitem__(r'errcode')

    @property
    def errmsg(self):

        return self.__getitem__(r'errmsg')
